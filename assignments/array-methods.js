...
// Problem 1
// find donations > 100
let findBigDonations = runners.filter(runner => runner.donation >= 100);
console.log(findBigDonations);

// Problem 2
// find all runner with shirt size S
let findSmallSize = runners.filter(shirt => shirt.shirt_size === "S");
console.log(findSmallSize);

// Problem 3
// change all size S shirt to M, size S OOS
let swapSmallSize = [];
...
runners.forEach(runner => {
  ...
  swapSmallSize.push(runner);
});
console.log(swapSmallSize);
